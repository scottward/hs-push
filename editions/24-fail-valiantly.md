...
Pause and ask yourself: _"What if achieving this goal was the only way to avoid something truly terrible? What if I acted as if **delaying this goal was not an option?**"_
...
Often, before too long, you'll hit on an idea or two that are actually not _that_ extreme — things you could actually try without sacrificing everything else.
